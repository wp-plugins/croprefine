		...
		$.post(ajaxurl, {'action': 'getimage','id':item }, 
		    function(r){			//console.log(r);
				...
				$.each( r.sizes, function( key, arr ) {
					var listitem = '<tr rel="crop_'+key+'"><td><a class="preview" rel="'+r.url+arr[0]+'" title="Preview '+arr[1]+'x'+arr[2]+' Crop" href="popover" data-ui="popover-trigger">' + arr[0] + '</a></td>';
